...
Flexibilización de algunos supuestos 
- Los métodos de machine learning no descansan en supuestos fuertes
...
**Ausencia**: 18 de octubre

Intentaremos recuperar esa clase en formato online
...
**Tarea de programación**: 6 de septiembre (tendrán 3 días)

**Entrega evaluación formativa 1**: 27 de septiembre (voluntaria, pero muy recomendada)

**Presentación mini proyecto 1**: 11 de octubre 

**Entrega evaluación formativa 2**: 15 de noviembre (voluntaria, pero muy recomendada)

**Presentación mini proyecto 2**: 29 de noviembre

---

## Artículos científicos

Deben formar duplas y elegir un artículo dentro de este listado

[listado artículos](https://1drv.ms/x/s!AuD1ibmmV6Q7ieNTC811vUfrq0_7OQ?e=dwJOWW)

--

Tendremos 2 presentaciones por clase

Debe durar como máximo 10 minutos (**habrá descuento**)

--

Se deben abordar, al menos, los siguientes elementos:

- Pregunta o motivación del artículo
- Metodología utilizada o reflexión
